...
//
#include <robin_behavior_tree/actions/mocks/CommonAction.h>
...
class CommonActionFixture : public ::testing::Test {
protected:
  ...
  CommonActionFixture() : node("~"), node_ns("")
  {
...
TEST_F(CommonActionFixture, tickRoot)
{
  std::string bt_file;
...
int main(int argc, char* argv[])
{
  ...
  ros::init(argc, argv, "common_action_test");
